...
implements LoaderManager.LoaderCallbacks<Cursor>
{
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        // Make sure I'm getting the correct request code,
        // And the operation was successful
        if (resultCode == EDITOR_REQUEST_CODE && resultCode == RESULT_OK) {

            // Refresh the screen
            // Restart the loader from the loader manager
            // and refills the data from the database and displays it in the list
            restartLoader();
        }
    }
}
