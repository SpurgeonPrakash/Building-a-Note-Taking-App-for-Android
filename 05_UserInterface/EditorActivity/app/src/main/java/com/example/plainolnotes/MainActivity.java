...
implements LoaderManager.LoaderCallbacks<Cursor>
{
    ...
    // Constant here only to identify the request when we come back to this activity
    ...
    // When this method is called, I want to open the new Activity
    public void openEditorForNewNote(View view) {
        ...
        // The new Activity will display the EditText component where
        // I can type a note
